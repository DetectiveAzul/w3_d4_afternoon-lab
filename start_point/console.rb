...
movie01 = Movie.new({ 'title' => 'Con Air', 'genre'=>'action', 'rating'=>6.8})
movie02 = Movie.new({ 'title' => 'Leaving Las Vegas', 'genre'=>'drama', 'rating'=>7.6})
movie03 = Movie.new({ 'title' => 'Face/Off', 'genre'=>'thriller', 'rating'=>7.3})
movie04 = Movie.new({ 'title' => 'Ghost Rider', 'genre'=>'superheroes', 'rating'=>5.2})
